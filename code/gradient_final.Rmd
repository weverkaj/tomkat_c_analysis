...
t.test(change10_future$change18)
t.test(change10_future$change21)

t.test(change40_future$change18)
t.test(change40_future$change21)
...
(bact_richness_change = ggplot(microbe_diversity_soil, aes(x = richness, y = change21 * 10)) +
  geom_point() +
  facet_wrap(. ~ depth_text) +
  ...
  theme(axis.text.y = element_text(size = 12),
        ...
        legend.text = element_text(size = 12),
        strip.background = element_rect(fill="white")) +
  ylab(expression("SOC Change 2018-2021 (g C kg soil " ^ "-1" * ")")) +
...
### plots
```{r}
(plot16s_10 = ggplot(scores_16s_10, aes(NMDS1, NMDS2, color = `2018` * 10)) +
  geom_point(size = 3) +
  ...
  scale_color_viridis_c(name = expression("SOC 0-10cm\n  (g C kg soil"^"-1"*")"), limits = c(20, 50), na.value = "#FDE725FF", breaks = c(2, 3, 4, 5) *10, labels=c(20, 30, 40, ">50")) +
...
(plot16s_40 = ggplot(scores_16s_40, aes(NMDS1, NMDS2, color = `2018` * 10)) +
  geom_point(size = 3) +
  ...
  scale_color_viridis_c(name = expression("SOC 10-40cm\n    (g C kg soil"^"-1"*")"), limits = c(10, 30), na.value = "#FDE725FF", breaks = c(10, 20, 30), labels=c(10, 20, ">30")) + 
...
```{r}
(function_16S_plot = ggplot(fam_carbon_function, (aes(x = c_o_ratio, y = `2018` * 10))) +
  geom_point() +
  theme_bw() +
  facet_grid(. ~ depth_text) +
  scale_color_manual(values = c("darkgreen", "purple"), name = "Depth") +
  ...
  ylab(expression("SOC 2018 (g C kg soil " ^ "-1" * ")")) +
...
```{r}
(function_16S_plot_future = ggplot(fam_carbon_function, (aes(x = c_o_ratio, y = change21 * 10))) +
  geom_point() +
  theme_bw() +
  facet_grid(. ~ depth_text) +
  scale_color_manual(values = c("darkgreen", "purple"), name = "Depth") +
  ...
  # geom_smooth(data = fam_carbon_function %>% filter(depth_cm == "0 to 10"), method = "lm", fill = "darkgreen", alpha = 0.1) +
  geom_smooth(method = "lm", color = "black", linetype = "dashed") +
  # ylab(expression("2018 Organic Carbon (g C kg soil " ^ "-1"))
  ylab(expression("SOC Change 2018-2021 (g C kg soil " ^ "-1" * ")")) +
  xlab("2018 Copiotroph:Oligotroph Ratio") + 
  scale_y_continuous(labels = scales::number_format(accuracy = 0.1)))
...
(fung_richness = ggplot(fungal_diversity_soil, aes(x = richness, y = `2018` * 10)) +
  geom_point() +
    theme_bw() +
  facet_wrap(. ~ depth_text) +
  ...
  theme(axis.text.y = element_text(size = 12),
        ...
        legend.text = element_text(size = 12),
        strip.background = element_rect(fill="white")) +
  ylab(expression("2018 SOC (g C kg soil" ^ "-1" * ")")) +
...
(fung_richness_recent = ggplot(fungal_diversity_soil, aes(x = richness, y = change18 * 10)) +
  geom_point() +
  theme_bw() +
  facet_wrap(. ~ depth_text) +
  ...
  theme(axis.text.y = element_text(size = 12),
        ...
        legend.text = element_text(size = 12),
        strip.background = element_rect(fill="white")) +
  ylab(expression("SOC Change 2015-18 (g C kg soil" ^ "-1" * ")"))  +
  xlab("Fungal ASV Richness 2018"))
```
...
```{r}
(fung_plot10 = ggplot(scores_fungal_10, aes(NMDS1, NMDS2, color = `2018` * 10)) +
  geom_point(size = 3) +
...
### plots
```{r}
(fung_plot40 = ggplot(scores_fungal_40, aes(NMDS1, NMDS2, color = `2018` * 10)) +
  geom_point(size = 3) +
...
```{r}
(saprotroph_plot = ggplot(guild_carbon, aes(x = saprotroph_only, y = change21 * 10)) +
  geom_point() +
  facet_wrap(. ~ depth_text) +
  theme_bw() +
  facet_grid(. ~ depth_text) +
  ...
  ylab(expression("SOC Change 2018-21 (g C kg soil" ^ "-1" * ")")) +
...
(veg_1_2 = ggplot(veg_scores, aes(NMDS1, NMDS2)) +
  geom_point(aes(color = `2018_10` * 10), size = 3) +
...
(veg_1_3 = ggplot(veg_scores, aes(NMDS1, NMDS3)) +
  ...
  scale_color_viridis_c(name = expression("SOC 0-10cm\n  (g C kg soil"^"-1"*")"), limits = c(20, 50), na.value = "#FDE725FF", breaks = c(2, 3, 4, 5) *10, labels=c(20, 30, 40, ">50")) +
  theme_bw())  +
  geom_text(aes(label = paste("stress = ", round(vegNMDS$stress, 3)), x = 0.-.85, y = -.6), size = 4, color = "black") +
  theme(axis.title = element_text(size = 14))
...
(veg_future = ggplot(veg_scores_future, aes(NMDS1, NMDS2)) +
  geom_point(aes(color = change21_10 * 10), size = 3) +
  ...
  scale_color_viridis_c(name = expression("SOC Change 2018-21\n    0-10cm (g C kg soil"^"-1"*")")) + 
  theme_bw()) +
  theme(axis.title = element_text(size = 14))
...
```{r}
(pg_plot = ggplot(fun_table_soil, aes(x = perennial_grass, y = change21_10 * 10)) +
  geom_point() +
  # xlim(0, 0.5) +
  ...
  ylab(expression("SOC 0-10 cm Change 2018-21 (g C kg soil" ^ "-1" * ")"))) 

(pg_plot40 = ggplot(fun_table_soil, aes(x = perennial_grass, y = change21_40 * 10)) +
  geom_point() +
  # xlim(0, 0.5) +
  geom_smooth(method = "lm", color = "black") +
  theme_bw() +
  # theme(axis.title = element_text()) +
  xlab("Perennial Grass Cover 2018") +
  ylab(expression("SOC 10-40 cm Change 2018-21 (g C kg soil" ^ "-1" * ")"))) 

(ag_plot = ggplot(fun_table_soil, aes(x = annual_grass, y = change21_10 * 10)) +
  geom_point() +
  # xlim(0, 0.5) +
  geom_smooth(method = "lm", color = "black") +
  theme_bw() +
...
(ag_plot40 = ggplot(fun_table_soil, aes(x = annual_grass, y = change21_40 * 10)) +
  geom_point() +
  # xlim(0, 0.5) +
  geom_smooth(method = "lm", color = "black") +
  theme_bw() +
...
```{r}
(pg_plot_l = ggplot(fun_table_soil, aes(x = perennial_grass, y = change21_10)) +
  geom_point() +
  # xlim(0, 0.5) +
  geom_smooth(method = "lm", color = "black") +
...
(pg_plot40_l = ggplot(fun_table_soil, aes(x = perennial_grass, y = change21_40)) +
  geom_point() +
  # xlim(0, 0.5) +
  geom_smooth(method = "lm", color = "black") +
  geom_label_repel(aes(label = rowname), min.segment.length = 0) +  
...
```{r}
(canopy_plot = ggplot(canopy_soil, aes(x = canopy_change, y = change21_10 * 10)) +
  geom_point() +
  # xlim(0, 0.5) +
  geom_smooth(method = "lm", color = "black") +
  theme_bw() +
  # theme(axis.title = element_text()) +
  xlab("Change in Woody Cover 2018-21") +
  ylab(expression("SOC 0-10 cm Change 2018-21 (g C kg soil" ^ "-1" * ")"))) 

(canopy_plot40 = ggplot(canopy_soil, aes(x = canopy_change, y = change21_40 * 10)) +
  geom_point() +
  # xlim(0, 0.5) +
  # geom_smooth(method = "lm", color = "black") +
  theme_bw() +
...
summary(c_o_fung_richness40_noint)
...
full_richness_future_mod40_noint = lm(change21_40 ~ richness + perennial_grass, data = future_table_soil40)
summary(full_richness_future_mod40_noint)

AIC(full_richness_future_mod40, full_richness_future_mod40_noint)

full_co_future_mod40 = lm(change21_40 ~ c_o_ratio*perennial_grass, data = future_table_soil40)
summary(full_co_future_mod40)

full_co_future_mod40_noint = lm(change21_40 ~ c_o_ratio + perennial_grass, data = future_table_soil40)
summary(full_co_future_mod40_noint)

AIC(full_co_future_mod40, full_co_future_mod40_noint)
...
AIC(final, full_richness_future_mod40, future40_noint, )
