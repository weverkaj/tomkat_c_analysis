...
soil10 = z[,3:5]
canopy10 = z[13:19] #%>% select(-FRCA12, -SALIX, -DIAU, - PSME)
otu10 = z[,20:ncol(z)] %>% select(where(~ any(. != 0))) # make sure no columns are all 0

c_40 = change_data40 %>% 
  select(c_2018, c_change)
...
```{r}
c_stock_10 = varpart(c_10$c_2018, all_veg10, otuNMDS_scores10, soil10)
# c_stock_10

plot(c_stock_10, bg = c("green", "brown", "purple"), Xnames = c("Plants", "16S", "Soil Texture" ), cutoff = -0.5)

c_stock_10family = varpart(c_10$c_2018, all_veg10, phylumNMDS_scores10, soil10)
# c_stock_10
...
```{r}
c_stock_10_veg = varpart(c_10$c_2018, canopyNMDS_scores10, vegNMDS_scores10)

plot(c_stock_10_veg)
```

```{r}
c_stock_40 = varpart(c_40$c_2018, all_veg40, otuNMDS_scores40, soil40)

c_stock_40family = varpart(c_40$c_2018, all_veg40, phylumNMDS_scores40, soil40)
# c_stock_40
...
```{r}
c_stock_40_veg = varpart(c_40$c_2018, canopyNMDS_scores40, vegNMDS_scores40)

plot(c_stock_40_veg)
```

```{r}
c_change_10 = varpart(c_10$c_change, all_veg10, otuNMDS_scores10, soil10)
# c_stock_10

plot(c_change_10, bg = c("green", "brown", "purple"), Xnames = c("Plants", "16S", "Soil Texture" ), cutoff = -0.5)

c_change_10family = varpart(c_10$c_change, all_veg10, phylumNMDS_scores10, soil10)
# c_stock_10
...
```{r}
c_change_10_veg = varpart(c_10$c_change, canopyNMDS_scores10, vegNMDS_scores10)

plot(c_change_10_veg)
```

```{r}
c_change_40 = varpart(c_40$c_change, all_veg40, otuNMDS_scores40, soil40)
# c_stock_10

plot(c_change_40, bg = c("green", "brown", "purple"), Xnames = c("Plants", "16S", "Soil Texture" ), cutoff = -0.5)

c_change_40family = varpart(c_40$c_change, all_veg40, phylumNMDS_scores40, soil40)
# c_stock_10
...
```{r}
c_change_40_veg = varpart(c_40$c_change, canopyNMDS_scores40, vegNMDS_scores40)
...
otu_model_10 = lm(c_2018 ~ NMDS1 + NMDS2 + NMDS3, data = otu_data10)
summary(otu_model_10)



otu_data40 = bind_cols(c_40, otuNMDS_scores40)
otu_model_40 = lm(c_2018 ~ NMDS1 + NMDS2 + NMDS3, data = otu_data40)
