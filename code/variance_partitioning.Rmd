...
otuNMDS40_scores = scores(otuNMDS10) %>% 
  as.data.frame()
...
```{r}
c_stock_10 = varpart(z$`2018`, all_veg10, otuNMDS_scores10, fungal_scores10)
# c_stock_10
...
```{r}
c_stock_40 = varpart(c_40$`2018`, all_veg40, otuNMDS_scores40, fungal_scores40)
...
```{r}
c_change_10 = varpart(c_10$change18, all_veg10, otuNMDS_scores10, fungal_scores10)
# c_stock_10
...
```{r}
c_change_40 = varpart(c_40$change18, all_veg40, otuNMDS_scores40, fungal_scores40)
# c_stock_10
