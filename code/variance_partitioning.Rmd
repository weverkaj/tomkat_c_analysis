...
plot(c_stock_10, bg = c("green", "brown", "purple"), Xnames = c("Plants", "Microbes", "Soil Texture"))
...
plot(c_stock_40,  bg = c("green", "brown", "purple"),  Xnames = c("Plants", "Microbes", "Soil Texture" ))
...
plot(c_change_10, bg = c("green", "brown", "purple"), Xnames = c("Plants", "16S", "Soil Texture" ))
...
plot(c_change_40, bg = c("green",  "purple", "brown"), Xnames = c("Plants", "16S", "Soil Texture" ), cutoff = -0.5)
...
# c_stock_10
plot(c_change_40_21, bg = c("green", "brown", "purple"), Xnames = c("Plants", "16S", "Soil" ))
...
# c_stock_10
plot(c_change_10_21, bg = c("green", "brown", "purple"), Xnames = c("Plants", "16S", "Soil Texture" ))
